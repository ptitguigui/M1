...
public class ComplexTree extends Tree {
    ...
    public ComplexTree() {
        ...
        final ActorRef noeud_3 = system2.actorOf(Node.props("noeud_3", printerActor, null), "noeud_3");
        final ActorRef noeud_4 = system2.actorOf(Node.props("noeud_4", printerActor, null), "noeud_4");
        List<ActorRef> liste_2 = new ArrayList<>();
        liste_2.add(noeud_3);
        liste_2.add(noeud_4);
        final ActorRef noeud_2 = system2.actorOf(Node.props("noeud_2", printerActor, liste_2), "noeud_2");
        final ActorRef noeud_6 = system.actorOf(Node.props("noeud_6", printerActor, null), "noeud_6");
